...
const include = [
  ...
  {%- endcapture -%}
  '{{ icon_url }}/favicon.202009.ico',
  '{{ icon_url }}/apple-icon.202009.png',
  '{{ icon_url }}/apple-icon-precomposed.202009.png',
  '{{ icon_url }}/apple-icon-57x57.202009.png',
  '{{ icon_url }}/apple-icon-60x60.202009.png',
  '{{ icon_url }}/apple-icon-72x72.202009.png',
  '{{ icon_url }}/apple-icon-76x76.202009.png',
  '{{ icon_url }}/apple-icon-114x114.202009.png',
  '{{ icon_url }}/apple-icon-120x120.202009.png',
  '{{ icon_url }}/apple-icon-144x144.202009.png',
  '{{ icon_url }}/apple-icon-152x152.202009.png',
  '{{ icon_url }}/apple-icon-180x180.202009.png',
  '{{ icon_url }}/android-icon-192x192.202009.png',
  '{{ icon_url }}/favicon-32x32.202009.png',
  '{{ icon_url }}/favicon-96x96.202009.png',
  '{{ icon_url }}/favicon-16x16.202009.png',
  '{{ icon_url }}/ms-icon-144x144.202009.png',
